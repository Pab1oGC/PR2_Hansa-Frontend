/**
 * src/pages/account/VerifiCode.jsx
 */
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="w-full max-w-4xl bg-white rounded-lg shadow-md overflow-hidden grid grid-cols-1 md:grid-cols-2">
        {/* Panel Izquierdo */}
        <div className="hidden md:flex bg-gradient-to-br from-[#0056d6] to-[#007bff] text-white p-8 flex flex-col justify-center">
        ...
        <div className="bg-[#eaf5ff] p-6 sm:p-8 flex flex-col justify-center">
          <button onClick={() => navigate("/login")} className="mb-6 self-start rounded-full border border-[#0c3c60] hover:bg-[#0c3c60]/10 transition p-2 w-10 h-10 flex items-center justify-center group" aria-label="Volver al login">
            <svg
              className="w-5 h-5 text-[#0c3c60] group-hover:text-[#0a2f4a] transition" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"  >
